    ...
    <BrowserRouter>
      <Routes>
        ...
        >
          ...
          {/* Doctor Routes - Service Request Workflow Only */}
          <Route path="service-request-queue" element={<ServiceRequestQueue />} />
          <Route path="patient-clinical-summary" element={<PatientClinicalSummary />} />
